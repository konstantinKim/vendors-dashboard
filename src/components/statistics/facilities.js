...
export default class Facilities extends Component {  
  componentWillMount(){
    ...
    statisticsActions.getFacilitiesStats(statistics.dateFrom, statistics.dateTo)        
  }
  ...
  render() {         
    ...
    if(facilities.facilitiesUsedList.length > 0){
      listTemplate = facilities.facilitiesUsedList.map(function (item, index) {
        return (
          <tr key={'fac_' + index}>
                ...
                <table className="table table-striped table-bordered table-hover" id="statistics-table" ref="statisticsTable">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th className="column-stats-footer">{facilities.totalProjects}</th>
                      <th className="column-stats-footer">{facilities.totalTons}</th>
                      <th className="column-stats-footer">100%</th>
                      <th className="column-stats-footer">{facilities.reused}</th>
                      <th className="column-stats-footer">{facilities.reusedPercent}%</th>
                      <th className="column-stats-footer">{facilities.recycled}</th>
                      <th className="column-stats-footer">{facilities.recycledPercent}%</th>
                      <th className="column-stats-footer">{facilities.disposed}</th>
                      <th className="column-stats-footer">{facilities.disposedPercent}%</th>
                    </tr>
                  </tfoot>
                  <tbody>
                    {listTemplate}
